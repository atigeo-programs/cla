...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $stateProvider.state('app', {
        ...
        resolve: loadSequence('jquery-sparkline', 'dashboardCtrl', 'angularBootstrapNavTree', 'treeCtrl', 'ngTable', 'ngTableCtrl'),
        title: 'Dashboard',
        ncyBreadcrumb: {
            label: 'Dashboards'
        }
    ...
    }).state('app.insights.analytics', {
        url: '/analytics',
        templateUrl: "assets/views/clinical-analytics.html",
        title: 'Clinical-analytics',
        icon: 'ti-layout-media-left-alt',
        resolve: loadSequence('chartjs', 'tc.chartjs', 'chartsCtrl', 'ngTable', 'ngTableCtrl', 'patientsCtrl'), //'ngTable', 'ngTableCtrl'
        ncyBreadcrumb: {
            label: 'Clinical Analytics'
        }
    }).state('app.insights.details', {
        url: '/details',
        templateUrl: "assets/views/patient-details.html",
        title: 'Patient Details',
        icon: 'ti-layout-media-left-alt',
        resolve: loadSequence('chartjs', 'tc.chartjs', 'chartsCtrl', 'flow', 'userCtrl', 'truncate', 'htmlToPlaintext', 'inboxCtrl'),
        ncyBreadcrumb: {
            label: 'Patient Details'
        }
    }).state('app.insights.timeline', {
        url: '/timeline',
        templateUrl: "assets/views/patient-timeline.html",
    ...
    }).state('app.insights.observations', {
        url: '/observations',
        templateUrl: "assets/views/patient-observations.html",
    ...
    }).state('app.datamanager.upload', {
        url: '/upload',
        templateUrl: "assets/views/data-upload.html",
        title: 'Data Upload',
        icon: 'ti-layout-media-left-alt',
        resolve: loadSequence('chartjs', 'tc.chartjs', 'chartsCtrl', 'ngTable', 'ngTableCtrl', 'angularFileUpload', 'uploadCtrl'), //'ngTable', 'ngTableCtrl'
        ncyBreadcrumb: {
            label: 'Data Upload'
        }
    }).state('app.datamanager.download', {
        url: '/download',
        templateUrl: "assets/views/data-download.html",
        title: 'Data Download',
        icon: 'ti-layout-media-left-alt',
        resolve: loadSequence('chartjs', 'tc.chartjs', 'chartsCtrl', 'ngTable', 'ngTableCtrl', 'angularFileUpload', 'uploadCtrl', 'wizardCtrl'), //'ngTable', 'ngTableCtrl'
        ncyBreadcrumb: {
            label: 'Data Download'
        }
    }).state('app.ui', {
    ...
    }).state('app.pages.messages.encounters', {
        url: '/encounters/:encounterID',
        templateUrl: "assets/views/pages_encounters.html",
        controller: 'ViewMessageCrtl'
